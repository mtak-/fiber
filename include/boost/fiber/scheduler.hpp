...
#include <boost/fiber/detail/list.hpp>
...
public:
    ...
    typedef detail::ready_list      ready_queue_type;

private:
    typedef detail::remote_ready_list   remote_ready_queue_type;
    typedef detail::worker_list         worker_queue_type;
    typedef detail::terminated_list     terminated_queue_type;
    typedef detail::sleep_list          sleep_queue_type;
